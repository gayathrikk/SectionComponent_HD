...
public class HD {
    ...
    @Parameters({"URL"})
    @Test(priority = 1)
    public void login(@Optional("https://apollo2.humanbrain.in/viewer/annotation/portal") String URL) throws InterruptedException {
        driver.get(URL);
    ...
    public void checkConsoleLog() {
        // Placeholder - Implement your actual browser console log checking here if needed
        System.out.println("Checking console log (placeholder method)...");
    }
}
